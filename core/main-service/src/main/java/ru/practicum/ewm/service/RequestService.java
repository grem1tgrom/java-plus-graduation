...
public class RequestService {
    ...
    public EventRequestStatusUpdateResult updateRequestStatus(
        ...
        List<Request> requests = repository.findAllByIdInAndStatus(updateDto.getRequestIds(), RequestStatus.PENDING);
        ...
        if (freeLimit != null && freeLimit == 0 && event.getParticipantLimit() > 0) {
            List<Request> pendingRequests = repository.findByEventIdAndStatus(eventId, RequestStatus.PENDING);
